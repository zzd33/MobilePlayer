...
import com.bobo.mobileplayer.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private boolean isUseSystem = true;//处理视频卡转圈圈-false自己写的 true系统
    /**视频进度的更新*/
    ...
    /**万能播放器切换到系统播放器*/
    private void showSwichPlayerDialog2(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("万能播放器提醒您");
        builder.setMessage("当您播放视频，有噪点的时候，试试切换到系统播放器。");
    ...
    private void setData() {
        if (mediaItems != null && mediaItems.size() > 0){
            ...
            Toast.makeText(VitamioVideoPlayer.this,"没有资源或资源损坏",Toast.LENGTH_SHORT).show();
        }
        setButtonState();
    }
...
//            Toast.makeText(SystemVideoPlayer.this,"文件已经不存在或格式不正确...",Toast.LENGTH_SHORT).show();
    ...
    private void showErrorDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("提示");
        builder.setMessage("抱歉不能播放这段视频!\nsorry  couldn't play this video !");
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                finish();
    ...
    class MyOnCompletionListener implements MediaPlayer.OnCompletionListener{
        ...
        public void onCompletion(MediaPlayer mp) {
            ...
            Toast.makeText(VitamioVideoPlayer.this,"播放完成："+mediaItem.getName(),Toast.LENGTH_SHORT).show();
